...
Route::get('/olahraga','PelajaranController@olg');
Route::get('/indo','PelajaranController@indo');
Route::get('/seni','PelajaranController@seni');
Route::get('/ips','PelajaranController@ips');
